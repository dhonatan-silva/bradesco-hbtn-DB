...
CREATE TABLE Endereco (id  integer, bairro varchar(255), cep integer, cidade varchar(255), enderco varchar(255), estado varchar(255), logradouro varchar(255), numero varchar(255), aluno_id bigint, primary key (id))
